...
CREATE TABLE `channel`  (
  ...
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '通道名称',
  `channel_code` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  `show_file` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '显示内容',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `Unique_key`(`channel_code`) USING BTREE COMMENT '编码唯一'
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '通道表' ROW_FORMAT = Compact;
...
INSERT INTO `channel` VALUES (4, '最代码', '4', '');
...
CREATE TABLE `plays_order`  (
  ...
  `file_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  `types` int(20) DEFAULT 0 COMMENT '0 图片 1 视频 2 文字',
  `suffix` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '后缀',
  `file_id` bigint(11) DEFAULT 0 COMMENT '文件ID',
  `ur` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  `content` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  `order_by` int(11) DEFAULT 0 COMMENT '播放顺序',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '播放顺序表' ROW_FORMAT = Compact;
...
INSERT INTO `plays_order` VALUES (19, 1, '最代码文件上传测试', 1, 'mp4', 0, 'D:/profile/最代码文件上传测试.mp4', 'zuidaima.com', 3, '');
INSERT INTO `plays_order` VALUES (20, 4, '我是文字', 2, '', 0, '', '<h1>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 标题</h1><div>&nbsp; &nbsp; &nbsp; 我是内容<span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容</span><span style=\"color: inherit;\">我是内容。</span></div>', 1, '');
INSERT INTO `plays_order` VALUES (21, 4, '最代码文件上传测试', 1, 'mp4', 0, 'D:/profile/最代码文件上传测试.mp4', 'zuidaima.com', 2, '');
INSERT INTO `plays_order` VALUES (22, 4, '最代码图片上传', 0, 'jpg', 0, 'D:/profile/最代码图片上传.jpg', '', 3, '');
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'CIFX5T2TRH4ZE3H1547301783471', 1547308644547, 15000);
...
CREATE TABLE `sys_dept`  (
  ...
  `leader` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '负责人',
  `phone` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '联系电话',
...
CREATE TABLE `sys_files`  (
  ...
  `content` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '文字内容',
  `suffix` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '后缀',
  `type` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '类型（0代表图片 1代表视频）',
  `del_flag` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '创建人姓名',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '创建者',
  `create_time` timestamp(0) DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_by_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '修改人名称',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '更新者',
  `update_time` datetime default null COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `unique_key`(`file_name`) USING BTREE COMMENT '文件名称唯一'
) ENGINE = InnoDB AUTO_INCREMENT = 73 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文件上传表' ROW_FORMAT = Compact;
...
INSERT INTO `sys_files` VALUES (71, 'D:/profile/最代码文件上传测试.mp4', '0', '最代码文件上传测试', '', 'zuidaima.com', 'mp4', '1', '0', '管理员', 'admin', '2019-01-12 22:05:00', '', '', '2019-01-12 22:05:20');
INSERT INTO `sys_files` VALUES (72, 'D:/profile/最代码图片上传.jpg', '0', '最代码图片上传', 'zuidaima.com', '', 'jpg', '0', '0', '管理员', 'admin', '2019-01-12 22:10:16', '', '', NULL);
...
CREATE TABLE `sys_job`  (
  ...
  `method_params` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '方法参数',
...
) ENGINE = InnoDB AUTO_INCREMENT = 377 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Compact;
...
INSERT INTO `sys_logininfor` VALUES (375, 'admin', '127.0.0.1', '内网IP', 'Firefox', 'Windows 7', '1', '密码输入错误1次', '2019-01-12 22:03:20');
INSERT INTO `sys_logininfor` VALUES (376, 'admin', '127.0.0.1', '内网IP', 'Firefox', 'Windows 7', '0', '登录成功', '2019-01-12 22:03:26');
...
) ENGINE = InnoDB AUTO_INCREMENT = 379 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Compact;
...
INSERT INTO `sys_oper_log` VALUES (370, '文件上传', 1, 'com.ruoyi.project.system.files.controller.FilesController.save()', 1, 'admin', '研发部门', '/file/add', '127.0.0.1', '内网IP', '{\"updateFlag\":[\"0\"],\"content\":[\"zuidaima.com\"],\"fileName\":[\"最代码文件上传测试\"],\"type\":[\"2\"],\"remark\":[\"\"]}', 0, NULL, '2019-01-12 22:05:00');
INSERT INTO `sys_oper_log` VALUES (371, '文件上传', 1, 'com.ruoyi.project.system.files.controller.FilesController.save()', 1, 'admin', '研发部门', '/file/add', '127.0.0.1', '内网IP', '{\"id\":[\"71\"],\"updateFlag\":[\"1\"],\"fileName\":[\"最代码文件上传测试\"],\"type\":[\"1\"],\"remark\":[\"\"]}', 0, NULL, '2019-01-12 22:05:20');
INSERT INTO `sys_oper_log` VALUES (372, '文件上传', 1, 'com.ruoyi.project.system.files.controller.FilesController.save()', 1, 'admin', '研发部门', '/file/add', '127.0.0.1', '内网IP', '{\"updateFlag\":[\"0\"],\"fileName\":[\"最代码图片上传\"],\"type\":[\"0\"],\"remark\":[\"zuidaima.com\"]}', 0, NULL, '2019-01-12 22:10:16');
INSERT INTO `sys_oper_log` VALUES (373, '文件上传', 1, 'com.ruoyi.project.system.files.controller.FilesController.addFileToShow()', 1, 'admin', '研发部门', '/file/addFileToShow', '127.0.0.1', '内网IP', '{\"list\":[\"71\"],\"channelId\":[\"1\"]}', 0, NULL, '2019-01-12 22:20:48');
INSERT INTO `sys_oper_log` VALUES (374, '通道', 2, 'com.ruoyi.project.system.channel.controller.ChannelController.editSave()', 1, 'admin', '研发部门', '/system/channel/edit', '127.0.0.1', '内网IP', '{\"id\":[\"1\"],\"name\":[\"一号通道\"],\"channelCode\":[\"1\"]}', 0, NULL, '2019-01-12 22:21:13');
INSERT INTO `sys_oper_log` VALUES (375, '通道', 1, 'com.ruoyi.project.system.channel.controller.ChannelController.addSave()', 1, 'admin', '研发部门', '/system/channel/add', '127.0.0.1', '内网IP', '{\"name\":[\"最代码\"],\"channelCode\":[\"4\"]}', 0, NULL, '2019-01-12 22:21:34');
INSERT INTO `sys_oper_log` VALUES (376, '文件上传', 1, 'com.ruoyi.project.system.files.controller.FilesController.addFileToShow()', 1, 'admin', '研发部门', '/file/addFileToShow', '127.0.0.1', '内网IP', '{\"list\":[\"70,71,72\"],\"channelId\":[\"4\"]}', 0, NULL, '2019-01-12 22:21:58');
INSERT INTO `sys_oper_log` VALUES (377, '通道', 2, 'com.ruoyi.project.system.channel.controller.ChannelController.editSave()', 1, 'admin', '研发部门', '/system/channel/edit', '127.0.0.1', '内网IP', '{\"id\":[\"4\"],\"name\":[\"最代码\"],\"channelCode\":[\"4\"]}', 0, NULL, '2019-01-12 22:22:02');
INSERT INTO `sys_oper_log` VALUES (378, '通道', 2, 'com.ruoyi.project.system.channel.controller.ChannelController.editSave()', 1, 'admin', '研发部门', '/system/channel/edit', '127.0.0.1', '内网IP', '{\"id\":[\"4\"],\"name\":[\"最代码\"],\"channelCode\":[\"4\"]}', 0, NULL, '2019-01-12 22:22:13');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '管理员', '00', 'ry@163.com', '15888888888', '0', '9bb570b323da9d39bcc855b65ca65424.jpg', 'e6314415342e92e189629f2233b15e55', 'd86bae', '0', '0', '127.0.0.1', '2019-01-12 22:03:26', 'admin', '2018-03-16 11:33:00', 'ry', '2019-01-12 22:03:26', '管理员');
