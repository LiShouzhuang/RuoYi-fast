...
import com.ruoyi.common.utils.file.FileUploadUtilsV2;
...
public class FilesController extends BaseController {
    ...
    private static String Save_Url = FileUploadUtilsV2.getDefaultBaseDir();
    ...
    public AjaxResult save(MultipartFile file, Files files) {
        ...
        try {
            ...
            if (file != null && !"2".equals(files.getType())) {
                File desc = FileUploadUtilsV2.getAbsoluteFile(Save_Url, files.getUrl());
    ...
    private Files dealFile(MultipartFile file, Files files) throws Exception {
        ...
        String suffix = FileUploadUtilsV2.dealName(file.getOriginalFilename());
